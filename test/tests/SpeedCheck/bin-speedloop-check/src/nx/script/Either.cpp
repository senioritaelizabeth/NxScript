...
::nx::script::Either Either_obj::Left( ::Dynamic v)
{
	return ::hx::CreateEnum< Either_obj >(HX_("Left",27,34,89,32),0,1)->_hx_init(0,v);
}

::nx::script::Either Either_obj::Right( ::Dynamic v)
{
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("nx.script.Either",44,0a,e4,71), ::hx::TCanCast< Either_obj >,Either_obj_sStaticFields,0,
